...
//---------------------------------------------------------
bool HX711::wait_ready_retry(int retries, unsigned long delay_ms) const
{
...
//---------------------------------------------------------
bool HX711::wait_ready_timeout(unsigned long timeout, unsigned long delay_ms) const
{
...
//---------------------------------------------------------
double HX711::get_scale() const
{
	return _scale;
}

//---------------------------------------------------------
void HX711::set_zero(long offset) {
	_zero = offset;
}

//---------------------------------------------------------
long HX711::get_zero() const
{
	return _zero;
}
//---------------------------------------------------------
